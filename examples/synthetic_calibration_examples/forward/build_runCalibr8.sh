...
PATH2="/home/sk63837/calibr8/flavor/linux-shared/build/calibr8/test/synthetic_calibration_examples/forward"

# Define commands
COMMAND1="capp rebuild calibr8 -j 4"
COMMAND2="primal notch2D_Asym_small_J2_plane_stress.yaml"
...
echo "========================"
echo "Running the Calibr8 Code: Forward"
echo "========================"
echo " " 
