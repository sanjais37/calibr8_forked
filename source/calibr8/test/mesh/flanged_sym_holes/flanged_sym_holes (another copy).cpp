...
int main()
{
    ...
    auto h1 = new_circle(Vector{-a/2, b+d/4, 0}, Vector{0, 0, 1}, Vector{0.5, 0, 0});
    auto h2 = new_circle(Vector{-a/2, h-b-b/4, 0}, Vector{0, 0, 1}, Vector{0.5, 0, 0});
    auto h3 = new_circle(Vector{15, 70, 0}, Vector{0, 0, 1}, Vector{10, 0, 0});
   ...
   embed(face, p20);
     ...
     // Embed the holes into the surface
   //embed(face, h1);
   //embed(face, h2);
   // embed(face, h3);
    //embed(face, h4);
